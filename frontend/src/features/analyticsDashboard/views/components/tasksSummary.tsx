  ...
  return (
    <Card className="flex justify-around p-6 bg-white shadow-md rounded-lg">
      <CardContent className="flex flex-col items-center">
        ...
        <Badge variant="default" className="text-2xl font-bold px-6 py-3 text-blue-600">
          {completed}
        </Badge>
      </CardContent>
      ...
      <CardContent className="flex flex-col items-center">
        ...
        <Badge variant="destructive" className="text-2xl font-bold px-6 py-3 text-gray-600">
          {open}
        </Badge>
      </CardContent>
    </Card>
